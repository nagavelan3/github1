...
export default function ServiceDetailsPage() {
    ...
    const service = {
        ...
        description: "We construct modern commercial complexes and office spaces that enhance productivity, strengthen brand identity, and support long-term business growth.",
        coverImage: "/build1.webp",
        fullDescription: "We construct modern commercial complexes and office spaces that enhance productivity, strengthen brand identity, and support long-term business growth. Our projects focus on smart space planning, advanced infrastructure, safety compliance, and flexible designs that adapt to evolving corporate needs.",
        icon: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4",
        subServices: [
            {
                title: "Shopping & Retail Complexes",
                description: "Designed to attract high customer footfall, these developments focus on visibility, smooth circulation, parking efficiency, and durable construction suited for continuous public use.",
                icon: "M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"
            },
            {
                title: "Mixed-Use Commercial Complexes",
                description: "Integrated developments combining retail outlets, office spaces, and shared amenities, maximizing land use while creating vibrant commercial hubs.",
                icon: "M3 21h18M5 21V7l8-4 8 4v14M8 21v-4h8v4"
            },
            {
                title: "Corporate Office Buildings",
                description: "Professionally designed standalone office buildings with flexible floor plans, modern services, and infrastructure that supports productivity and future expansion.",
                icon: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"
            },
            {
                title: "IT Parks & Technology Offices",
                description: "Large-scale office campuses built for IT and technology companies, featuring scalable layouts, high-capacity utilities, and uninterrupted operational support.",
        ...
        capabilities: [
            {
                ...
                description: "We design efficient and professional office layouts that maximize workspace utilization, enhance employee comfort, and project a strong corporate identity while fully complying with regulatory and safety standards.",
                image: "/build5.webp",
                points: [
                    "Optimized workspace planning",
            ...
            },
            {
                ...
                description: "We execute commercial construction using high-quality materials, skilled workmanship, and strict safety practices to deliver durable, functional, and future-ready buildings that meet business and regulatory standards.",
                image: "/build7.webp",
                points: [
                    "Use of premium construction materials",
                    "Skilled and experienced workforce",
                    "Strict safety and quality controls",
                    "Durable and reliable building structures",
                    "Built to support future expansion and use"
                ]
            },
            {
                id: "management",
                ...
                description: "We manage commercial projects with structured coordination, transparent cost management, and strict schedule control to ensure smooth execution and timely delivery while meeting client expectations.",
                image: "/build3.webp",
                points: [
                    "Centralized project coordination",
                    "Transparent budgeting and cost control",
                    "Strict timeline and milestone tracking",
        ...
        recentProjects: ["/build6.webp", "/build7.webp", "/build3.webp", "/build8.webp"]
    };
