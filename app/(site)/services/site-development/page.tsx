...
export default function ServiceDetailsPage() {
    ...
    const service = {
        id: "site-development",
        title: "Architectural & Structural Consultancy",
        ...
        coverImage: "/build6.webp",
        fullDescription: "Our architectural and structural consultancy services focus on innovative design, technical precision, and full regulatory compliance. We deliver well-engineered solutions that balance aesthetics, safety, sustainability, and cost efficiency, providing a strong and reliable foundation for successful construction projects.",
        icon: "M4 8V4m0 0h4M4 4l5 5m11-1V4m0 0h-4m4 0l-5 5M4 16v4m0 0h4m-4 0l5-5m11 5l-5-5m5 5v-4m0 4h-4",
        subServices: [
            {
                title: "Architectural Planning & Design",
                description: "Innovative building designs with efficient layouts, aesthetic appeal, and user-focused planning.",
                icon: "M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z"
            },
            {
                title: "Structural Design & Engineering",
                description: "Safe and economical structural systems designed to withstand loads, seismic forces, and long-term usage.",
                icon: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"
            },
            {
                title: "3D Visualization & Working Drawings",
                description: "Detailed drawings and visual models to clearly define design intent and execution requirements.",
                icon: "M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"
            },
            {
                title: "Approval & Regulatory Support",
                description: "Assistance with statutory approvals, codes, and local authority compliance.",
        ...
        capabilities: [
            {
                ...
                description: "We develop creative architectural concepts and precise structural designs that ensure functional layouts, structural safety, sustainable practices, and full compliance with applicable building codes and standards.",
                image: "/build5.webp",
                points: [
                    "Creative architectural concept development",
            ...
            },
            {
                ...
                description: "We provide expert technical guidance and continuous on-site support during construction to ensure designs are correctly executed and structural integrity is maintained throughout the project.",
                image: "/build7.webp",
                points: [
            ...
            },
            {
                ...
                description: "We coordinate design reviews, technical approvals, and stakeholder communication to ensure smooth execution, consistent quality, and timely completion of the project.",
                image: "/build3.webp",
                points: [
                    "Design review and approval coordination",
                    "Technical documentation management",
                    "Stakeholder and consultant coordination",
                    "Quality consistency across stages",
        ...
        recentProjects: ["/build6.webp", "/build2.webp", "/build4.webp", "/build7.webp"]
    };
